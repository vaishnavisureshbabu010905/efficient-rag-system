...
def get_llm_provider(provider: Optional[str] = None, model: Optional[str] = None,
    ...
    2. Environment variables: LLM_PROVIDER, LLM_MODEL, LLM_API_KEY, LLM_TEMPERATURE, LLM_MAX_TOKENS
    ...
    if provider == "openai":
        ...
        raise ValueError(f"Unknown LLM provider: {provider}. Use 'openai', 'anthropic', or 'mock'.")
